...
module.exports = async function(input) {
  ...
  console.log("DB TYPE: " +input.type);
  switch(input.type) {
...
async function createAccount(data){
  ...
  var query = connection.query("INSERT INTO user_account SET ?", data, function(error, result){
    if(error){
...
*/
async function createAccount2(accountType, email, password, name, accountDetails){
